...
<head>
    ...
    <link rel='stylesheet' href='insert_tiramisu.css'>
</head>
<body>
<div class="h-wrapper">
        <div class="form-box login">
            ...
            <h2> 點餐 </h2>
            <form action="insert_tiramisu.php" method="post">
                <div class="input-box">
                ...
                <select id='spicy' class='select' name='category'>
                        <option value='Little'>No Sugar</option>
                        <option value='Half'>Half Sugar</option> 
                        <option value='Standard'>Standard</option> 
                </select> 
                <label for="category">Sugar Level:</label>
                </div>   
